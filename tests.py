...
class TestQtGUI(unittest.TestCase):
    ...
    def test_ledger_txn_edit(self):
        ...
        self.assertEqual(dw.txns_display.txn_display_data[txn.id]['widgets']['labels']['balance'].text(), '105')
        self.assertEqual(dw.txns_display.txn_display_data[txn2.id]['widgets']['labels']['balance'].text(), '125')
        self.assertEqual(dw.txns_display.txn_display_data[txn3.id]['widgets']['labels']['balance'].text(), '150')
