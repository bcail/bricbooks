...
class SQLiteStorage:
    ...
    def _setup_db(self):
        ...
        conn.execute('CREATE TABLE accounts (id INTEGER PRIMARY KEY, type INTEGER, user_id TEXT, name TEXT UNIQUE, parent_id INTEGER, closed INTEGER,'\
                'FOREIGN KEY(parent_id) REFERENCES accounts(id))')
        conn.execute('CREATE TABLE budgets (id INTEGER PRIMARY KEY, name TEXT UNIQUE, start_date TEXT, end_date TEXT)')
        ...
        conn.execute('CREATE TABLE payees (id INTEGER PRIMARY KEY, name TEXT UNIQUE, notes TEXT)')
        conn.execute('CREATE TABLE scheduled_transactions (id INTEGER PRIMARY KEY, name TEXT UNIQUE, frequency INTEGER, next_due_date TEXT, txn_type TEXT, payee_id INTEGER, description TEXT,'\
