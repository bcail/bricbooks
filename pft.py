...
class AddTransactionWidget(ttk.Frame):
    ...
    def __init__(self, master, db_connection, reload_ledger):
        ...
        self.date_box = ttk.Entry(self, width=DATE_WIDTH)
        self.payee_entry = ttk.Entry(self, width=PAYEE_WIDTH)
        self.amount_box = ttk.Entry(self, width=AMOUNT_WIDTH)
        ...
        self.date_box.grid(row=0, column=1, sticky=(tk.N, tk.S, tk.E, tk.W), padx=5)
        self.payee_entry.grid(row=0, column=2, sticky=(tk.N, tk.S, tk.E, tk.W), padx=5)
        self.amount_box.grid(row=0, column=3, sticky=(tk.N, tk.S, tk.E, tk.W), padx=5)
