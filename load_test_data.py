...
def _load_data(storage, many_txns):
    ...
    storage.save_txn(bb.Transaction(splits={opening_balances: D('-1000'), checking: 1000}, txn_date='2018-01-01'))
    storage.save_txn(bb.Transaction(splits={opening_balances: D('-1000'), savings: 1000}, txn_date='2018-01-01'))
    storage.save_txn(bb.Transaction(splits={checking: D('-10'), restaurants: 10}, txn_date='2018-01-01', txn_type='123', payee=payee))
    storage.save_txn(bb.Transaction(splits={checking: D('-20'), restaurants: 20}, txn_date='2018-01-02'))
    storage.save_txn(bb.Transaction(splits={checking: D('-30'), restaurants: 30}, txn_date='2018-01-04'))
    storage.save_txn(bb.Transaction(splits={checking: D('-40'), restaurants: 40}, txn_date='2018-01-06'))
    storage.save_txn(bb.Transaction(splits={checking: D('-50'), restaurants: 50}, txn_date='2018-01-07'))
    storage.save_txn(bb.Transaction(splits={checking: D('-60'), restaurants: 60}, txn_date='2018-01-08'))
    storage.save_txn(bb.Transaction(splits={checking: D('100'), savings: '-100'}, txn_date='2018-01-09'))
    storage.save_txn(bb.Transaction(splits={checking: D('-70'), restaurants: 70}, txn_date='2018-01-10'))
    storage.save_txn(bb.Transaction(splits={checking: D('-80'), restaurants: 80}, txn_date='2018-01-11'))
    storage.save_txn(bb.Transaction(splits={checking: D('-90'), restaurants: 90}, txn_date='2018-02-11'))
    storage.save_txn(bb.Transaction(splits={checking: D('-180'), housing: 180}, txn_date='2018-02-12'))
    storage.save_txn(bb.Transaction(splits={checking: D('80.13'), savings: '-80.13'}, txn_date='2018-02-13'))
    storage.save_txn(bb.Transaction(splits={checking: D('-50'), gas_stations: 50}, txn_date='2018-02-14'))
    storage.save_txn(bb.Transaction(splits={checking: D('-70'), gas_stations: 40, restaurants: 30}, txn_date='2018-02-15'))
    storage.save_txn(bb.Transaction(splits={checking: D('-10'), gas_stations: 10}, txn_date='2018-02-16'))
    storage.save_txn(bb.Transaction(splits={checking: D('-20'), gas_stations: 20}, txn_date='2018-02-17'))
    storage.save_txn(bb.Transaction(splits={checking: D('-40'), gas_stations: 40}, txn_date='2018-02-18'))
    storage.save_txn(bb.Transaction(splits={checking: D('-30'), gas_stations: 30}, txn_date='2018-02-19'))
    storage.save_txn(bb.Transaction(splits={checking: D('-50'), gas_stations: 50}, txn_date='2018-02-21'))
    storage.save_txn(bb.Transaction(splits={checking: D('-70'), gas_stations: 70}, txn_date='2018-02-23'))
    storage.save_txn(bb.Transaction(splits={checking: D('-90'), gas_stations: 90}, txn_date='2018-02-24'))
    storage.save_txn(bb.Transaction(splits={checking: D('40'), savings: '-40'}, txn_date='2018-02-25'))
    ...
    if many_txns:
        ...
        for i in range(1000):
            ...
            txn = bb.Transaction(splits={checking: amt * D(-1), restaurants: amt}, txn_date='2018-04-%s' % day)
